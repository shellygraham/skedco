### [Skedco](http://skedco.com) Changelog
...
* Added WAI-ARIA landmark roles to enrich semantics and improve accessibility. [Stacey Cordoni](https://github.com/staceycordoni) [#32](https://github.com/toddmotto/skedco/pull/32)
...
* Separated WordPress script enqueue to load Conditionizr, Modernizr in head: 'function skedco_header_scripts()'
* Hard-coded jQuery and CDN fallback into footer.php above custom theme scripts, more reliable fallback method
* Load custom theme scripts in footer: 'function skedco_footer_scripts()'
...
* Update default Skedco logo and gravatar
...
* Custom Comments callback - wp_list_comments('type=comment&callback=skedcocomments'); editable comments now in functions.php
...
* Custom callback for wp_nav_menu, now in functions.php with skedco_nav(); in header.php
...
* Updated screenshot.png logo to new Skedco branding
...
* Move toddmotto.com/skedco/ to new skedco.com domain
